    ...
    function touchmove( event ) {
        ...
        switch ( event.touches.length ) {
            ...
            case 2:
                var dx = event.touches[ 0 ].pageX - event.touches[ 1 ].pageX;
                var dy = event.touches[ 0 ].pageY - event.touches[ 1 ].pageY
                var xxxx= x1 - event.touches[ 0 ].pageX;
                var xxxx2= x2 - event.touches[ 1 ].pageX;

                var yyyy= y1 - event.touches[ 0 ].pageY;
                var yyyy2= y2 - event.touches[ 1 ].pageY;

                var x = Math.abs(xxxx-xxxx2);
                var y = Math.abs(yyyy-yyyy2);
