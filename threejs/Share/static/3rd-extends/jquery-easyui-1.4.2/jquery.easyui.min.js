...
(function ($) {
    function _a1(_a2) {
        ...
        var _a5 = $(_a2).addClass("pagination").html("<div class='pageDiv' style='position:absolute;right:25px;margin-top:7px;'><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table></div>");

        _a5.find('.pageDiv').append($("<div class=\"pagination-info\"></div>"))
                    ...
                    if (_a8 == "first") {
                        ...
                        if (_a8 == "prev") {
                            ...
                            if (_a8 == "next") {
                                ...
                                $("<span style=\"padding-left:6px;\"></span>").html(_a4.pageText).appendTo(tr).wrap("<td></td>");
                                ...
                                if (_a8 == "last") {
                                    ...
                                    if (_a8 == "manual") {
                                        bb.after = $("<td class='pageNumber'></td>").appendTo(tr);
                                    } else {
                                        if (_a8 == "refresh") {
        ...
        var btn2 = _a4.nav["refresh"];
        var refresh = $("<a href=\"javascript:void(0)\"></a>").appendTo(tr);
        refresh.wrap("<td></td>");
        refresh.linkbutton({
            iconCls: btn2.iconCls,
            plain: true
        }).unbind(".pagination").bind("click.pagination", function () {
            btn2.handler.call(_a2);
        });


        bb.refresh = refresh;

        $("<div style='float:right;margin-top:11px;'></div>").append(refresh).appendTo(_a5)
    ...
    function _b2(_b3, _b4) {
        ...
        if (bb.after) {
            ...
            if(_b7<len){
                ...
                var offset=(len-1)/2;
                if(_b6.pageNumber<=offset){
                    for(i=1;i<=offset+1;i++){
                        btn.push(i);
                    }
                    btn.push('...');
                    btn.push(_b7);
                }else if(_b6.pageNumber>_b7-offset){
                    btn.push(1);
                    btn.push('...')
                    ...
                    for(i=Math.ceil(offset/2);i>=1;i--){
                        btn.push(_b6.pageNumber-i);
                    }
                    btn.push(parseInt(_b6.pageNumber));
                    for(i=1;i<=offset/2;i++){
                        btn.push(parseInt(_b6.pageNumber)+i);
                    }
                    btn.push('...');
                    btn.push(_b7);
                }
            ...
            for(var i = 0 ; i < btn.length; i++){
                if(btn[i] == _b6.pageNumber){
                    bb.after.append("<a class='active'>"+btn[i]+"</a>");
                }else{
                    bb.after.append("<a>"+btn[i]+"</a>")
                }
            }


            bb.after.find('a').click(function(){
                var page = $(this).text();
                if(page != _b6.pageNumber && page!=='...'){
                    _ae(_b3,page )
                }
            })
        ...
        _ba = _ba.replace(/{pageSize}/, _b6.pageSize);
    ...
    function _d8(_d9) {
        ...
        $(_d9).unbind().bind("mouseover", function (e) {
            ...
            if (tt.hasClass("tree-hit")) {
                ...
                if (tt.hasClass("tree-checkbox") || tt.hasClass("checkbox-big") ) {
                    _104(_d9, _dd[0]);
                    return false;
                } else {
                    _18a(_d9, _dd[0]);
        ...
        render: function (_1c3, ul, data) {
            ...
            function _1c5(_1c6, _1c7) {
                ...
                for (var i = 0; i < _1c7.length; i++) {
                    ...
                    cc.push("<li>");
                    cc.push("<div id=\"" + item.domId + "\" class=\"tree-node\" style=\"position:relative\">");
                    ...
                    if (opts.checkbox) {
                        if ((!opts.onlyLeafCheck) || _1c8) {
                            ...
                            /*---------为了扩大 点击面积-------------------*/
                            cc.push("<span class=\"checkbox-big\"></span>");
                        }
                    }
...
(function ($) {
    ...
    function _611(_6e1, _6e2) {
        ...
        // new---------------------------------------------------------start
        if (opts.pagination) {
            $.extend(_6e3, {pageNumber: opts.pageNumber || 1, pageSize: opts.pageSize});
        }
        if (opts.sortName) {
            $.extend(_6e3, {sortName: opts.sortName, sortFlag: opts.sortName ? opts.sortOrder : ""});
        }
        // new---------------------------------------------------------end
        ...
        function _6f1(name) {
            ...
            return {
                init: function (_6f3, _6f4) {
                    ...
                    if (isA(_6fa, name)) {
                        //给默认的加载控件添加样式 和边距
                        //_6fa.closest('td').css('textAlign','center');
    ...
    var _6fc = $.extend({}, _6ee(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            ...
            init: function (_70c, _70d) {
                ...
                $(_713)._outerWidth(_714)._outerHeight(32);
            }
        }
    });
    $.fn.datagrid.methods = {
