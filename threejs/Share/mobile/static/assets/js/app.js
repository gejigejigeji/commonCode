  ...
  window.app = {
    ...
    addUrlParams: function (url, params, isUrl) {
      ...
      loginOut:function(){
          ...
          var url = $.cookie('shareLink');
          window.location.href=url;
      },

      showAlert:function(msg){

          var $div = $("<div class='am-modal am-modal-alert'>" +
          ...
          $div.on('closed.modal.amui',function(){
              $div.remove();
          });
      },
      ...
      showMessage:function(msg,timer){
          ...
          var $div = $("<div class='i2-alert'>" +
              "<div>"+
              "<span class='i2-text'></span>"+
              "</div>"+

              "</div>");

          $div.find('.i2-text').text(msg||'请求异常');
